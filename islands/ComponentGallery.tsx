...
export default function ComponentGallery(props: ComponentGalleryProps) {
    return (
        <>
            <Section title='Button' island={true} source={props.sources.Button}>
                <Button>クリック</Button>
            ...
            >
                <ColoredButton>クリック</ColoredButton>
            </Section>

            <Section title='LinkButton' source={props.sources.LinkButton}>
                <LinkButton>
            ...
            <Section title='Input' island={true} source={props.sources.Input}>
