    ...
    return (
        <div class='grid md:grid-cols-3 gap-6 md:gap-14'>
            ...
            <div class={item}>
                <FeatureIcons.Island />
                <div class={desc}>
                    <b>Island based client hydration</b> for maximum
                    interactivity.
                </div>
            </div>
            ...
            <div class={item}>
                ...
                <div class={desc}>
                    <b>Zero runtime overhead</b>: no JS is shipped to the client
                    by default.
                </div>
            </div>
    ...
    return (
        <section class='max-w-screen-md mx-auto my-16 px(4 sm:6 md:8) space-y-12'>
            <div class='md:flex items-center'>
                <div class='flex-1 text-center md:text-left'>
                    <h2 class='py-2 text(5xl sm:5xl lg:5xl gray-900) sm:tracking-tight sm:leading-[1.1]! font-extrabold'>
                        The <span class='text-green-500'>next-gen</span> web
                        framework.
                    </h2>
            ...
            <p class='text-gray-600'>
                Fresh embraces the tried and true design of server side
                rendering and progressive enhancement on the client side.
            </p>
        </section>
    )
}
...
function GettingStarted(props: { origin: string }) {
    return (
        <section class='max-w-screen-md mx-auto my-16 px(4 sm:6 md:8) space-y-4'>
            ...
            <p class='text-gray-600'>
                Enter the newly created project directory and run the following
...
function Example() {
    return (
        <section class='max-w-screen-md mx-auto my-16 px(4 sm:6 md:8) space-y-4'>
            ...
            <p class='text-gray-600'>
                This text is being server side rendered on the fly. It was
                rendered at {timeFmt.format(new Date())}.
            </p>
            <p class='text-gray-600'>
                The counter below was rendered on the server with a starting
                value of 3, and was then hydrated on the client to provide
                interactivity. Try out the buttons!
            </p>
            <Counter start={3} />
            <p class='text-gray-600'>
                Only the JS required to render that counter is sent to the
                client.
            </p>
        </section>
    )
...
function Showcase() {
    return (
        <section class='max-w-screen-md mx-auto my-16 px(4 sm:6 md:8) space-y-4'>
            ...
            <p class='text-gray-600'>
                Below is a selection of projects that have been built with
                Fresh.
            </p>
